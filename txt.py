...
FOOD_DB = {
    ...
    "족발": {"kcal": 350, "carb": 0, "protein": 25, "fat": 25},  # 1인분
    "김": {"kcal": 5, "carb": 0.5, "protein": 0.3, "fat": 0.1},  # 1장
    ...
    "초콜릿": {"kcal": 220, "carb": 25, "protein": 3, "fat": 12}, # 1조각
    "사탕": {"kcal": 50, "carb": 13, "protein": 0, "fat": 0},    # 1개
}
...
with col1:
    sex = st.radio("성별", ["남", "여"])
with col2:
    age = st.number_input("나이", 5, 100, 20)   # 더 넓은 연령대 가능
with col3:
